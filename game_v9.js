    ...
    try {
        ...
        try {
            ...
            renderSnakes.forEach(snake => {
                ...
                // FIX: BLIND EFFECT (Client Side Visual)
                // If *my* entry has blindTimer > 0, blind the screen
                // For local single player, just check snake[0]
                ...
                // Multi: Check if I AM the blinded snake
                // TODO: Implement Client ID check for Multi Blind
