...
window.addEventListener('DOMContentLoaded', () => {
    ...
    class Game {
        ...
        initListeners() {
            ...
            this.toggleTouchListeners(true); // Enable initially
            ...
            if (btnHighScores) {
                bindButton(btnHighScores, () => {
                    ...
                    if (highScoreScreen) {
                        ...
                        // CRITICAL FIX: Disable Game Touch Listeners so Browser handles scrolling
                        this.toggleTouchListeners(false);
                    }
                });
            }
            ...
            bindButton(btnBackHighScores, () => {
                ...
                // CRITICAL FIX: Re-enable Game Touch Listeners
                this.toggleTouchListeners(true);
            });
        }

        // Helper to toggle global touch listeners
        toggleTouchListeners(enable) {
            if (enable) {
                ...
                console.log("Game Touch Listeners: ENABLED");
            } else {
                window.removeEventListener('touchstart', this.boundTouchStart);
                window.removeEventListener('touchmove', this.boundTouchMove);
                window.removeEventListener('touchend', this.boundTouchEnd);
                console.log("Game Touch Listeners: DISABLED");
            }
        }
    }
